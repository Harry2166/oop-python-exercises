...
class SocialNetwork():
  ...
  def send_friend_request(self, user1, user2): # -> there should be some sort of notification to user2 so that they can approve or disapprove of the friend request, will think of this next time!
    return
